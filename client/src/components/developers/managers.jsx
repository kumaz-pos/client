        ...
        <div class="d-flex">
          ...
          <div class="ms-auto text-secondary">
            ...
            <div class="ms-2 d-inline-block">
              {
                userData.role === "cashier" ? null :  <Link to="/home/users/register-manager" className='btn btn-primary d-none d-sm-inline-block'>
                Add Manager
              </Link>
              }
...
userData.role!=="cashier" ?  <>
  <Link to={`/home/users/manager/${item._id}`} class="btn btn-green">
View 
</Link>
<Link to={`/home/users/manager/update/${item._id}`} class="btn btn-azure ">
Update
</Link>
<button  onClick={()=>{
  dispatch(deletemanager(item._id,signature))
