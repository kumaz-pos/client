...
import {managersignin} from "../../redux/actions/manager"
...
function ManagerSignin() {
  ...
  function managerLogin(e) {
      e.preventDefault();
        ...
        dispatch(managersignin(email,password));
  ...
  return (
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" onSubmit={managerLogin}  autocomplete="off" novalidate>
          <div class="card-body">
          ...
          error &&      <div class="danger" style={{display:"flex","justifyContent":"center","color":"red"}}> {
            ...
            <div class="mb-3">
              ...
              <div class="input-group input-group-flat">
                <input  onChange={(e)=>setpassword(e.target.value)}   type="password" class="form-control"  placeholder="Email"  autocomplete="off"/>
