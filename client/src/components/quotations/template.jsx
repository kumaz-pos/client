...
console.log(id);
    ...
    const quotation=useSelector((state)=>state.getQuotation);
  
    const {loading,data,error}=quotation;
...
function goHome() {
  window.location.href="http://localhost:3000/home/quotations"
}
  return (
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-6 text-end">
                   ...
                   <p class="h3">{data? data.prospectName : null}</p>
                   <address>
                     {data? data.prospectNumber : null}<br/>
          ...
          <div class="col-12 my-5">
            <h1>{data? data.quotationNumber :null}</h1>
          </div>
        </div>
