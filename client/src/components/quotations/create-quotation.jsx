...
function CreateQuotation({userData}) {
...
function saveQuote() {
  ...
  if (!currency && !prospectName  && !prospectNumber) {
    alert("Please Fil in the prospect name and number as well as the currency")
  }else{
          ...
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              ...
              <div style={{display:"flex",gap:"1rem"}} class="col-auto ms-auto d-print-none">
                <button onClick={()=>saveQuote()} type="button" class="btn btn-info" onclick="javascript:window.print();">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Save changes</button>
                  ...
                  {item.name} {item.brand} {item.model} {item.year}
                      ...
                      {
                         currency === "ZIG" ?
                      item.total * Number(rate) : item.total
                      }
                      </td>
                    </tr>
                    })
                  ...
                  <tr>
                    ...
                    <td colspan="4" class="strong text-end"></td>
                    <td class="text-end">
                    <span className="strong"> Vat Due</span>
...
currency === "ZIG" ?
vatDue * Number(rate).toFixed(2) :  vatDue.toFixed(2)        
...
vatDue * Number(rate).toFixed(2) :  vatDue.toFixed(2)        
                  ...
                  <tr>
                    ...
                    <td colspan="4" class="font-weight-bold text-uppercase text-end"></td>
...

{
  /** <div class="col-6 text-end">
                    ...
                    <button class="tag " style={{padding:"0.3rem"}}>
