...
import {cashiersignin} from "../../redux/actions/cashier"
...
function CashierSignin() {
  ...
  const {cashierInfo,loading,error}=cashierSignin;
  const dispatch = useDispatch();
  const navigate = useNavigate();
  function cashierLogin(e) {
      e.preventDefault();
     
    
        dispatch(cashiersignin(email,password));
  ...
  return (
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" onSubmit={cashierLogin}  autocomplete="off" novalidate>
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Cashier Login</h2>
            {
        loading && <AuthLoader/>
     }
        {
